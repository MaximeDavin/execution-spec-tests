...
- ✨ Added `--feature` flag to the `fill` command, which allows the user to specify a feature that must be enabled for all tests during filling (supports only `eip_7702` and `eof_v1`) ([#781](https://github.com/ethereum/execution-spec-tests/pull/781)).
